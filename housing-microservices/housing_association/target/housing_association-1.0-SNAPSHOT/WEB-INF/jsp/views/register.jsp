...
<div class="jumbotron">
    <div class="custom-container">
        ...
        <hr class="my-4"/>
        <form:form method="POST" action="/housing/home/register" modelAttribute="registerForm" class="form-group">
            ...
            <%--Buttons--%>
            <div class="Row">
                <div class="Column"><a href="/housing/home"><input type="button" class="btn btn-danger" style="width:115%" value='<spring:message code="label.cancel"/>'></a></div>
