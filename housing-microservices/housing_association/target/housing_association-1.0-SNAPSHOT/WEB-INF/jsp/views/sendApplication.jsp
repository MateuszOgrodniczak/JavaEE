...
<head>
    ...
    <link href="/housing/resources/css/bootstrap-flatly.css" rel="stylesheet"
          type="text/css"/>
    <link href="/housing/resources/css/multi-select.css" rel="stylesheet" type="text/css" />
    <script
            src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script
            src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <script src="/housing/resources/js/jquery-multiselect.js" type="text/javascript"></script>
    <script src="/housing/resources/js/jquery-quicksearch.js" type="text/javascript"></script>
...
<div class="jumbotron">
    <div class="custom-container-big">
        ...
        <form:form action="/housing/userApplications/${userRole}/saveApplication" method="POST" modelAttribute="application">
            <div class="Row">
                <div class="Column-label"><form:label class="col-form-label" path="title"><spring:message
                        code="label.request.subject"/></form:label></div>
                <div class="Column-input"><form:input class="form-control" required="required" path="title"/></div>
                <div class="Column"><form:errors class="text-danger" path="title"/></div>
            </div>
            <div class="Row">
                <div class="Column-label"><form:label class="col-form-label" path="body"><spring:message
                        code="label.request.text"/></form:label></div>
                <div class="Column-input-long"><form:textarea class="form-control" path="body"/></div>
            </div>
            <div class="Row">
            ...
            <%--Buttons--%>
            <div class="Row">
                <div class="Column"><a href="/housing/${userRole}"><input type="button" class="btn btn-danger" style="width:115%"
