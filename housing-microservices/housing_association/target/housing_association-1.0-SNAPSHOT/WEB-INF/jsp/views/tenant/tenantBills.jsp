        ...
        <div id="bills">
            ...
            <table class="table table-hover">
                ...
                <c:forEach var="bill" items="${bills}">
                    ...
                    <td>
                        <a href="/housing/tenant/consumptions/${bill.id}">
                    ...
                    <c:choose>
                        <c:when test="${bill.accepted && !bill.removed}">
                            <td>
                                <a href="/housing/tenant/removeBill/${bill.id}">
                        ...
                        <c:otherwise>
                            ...
                            <c:if test="${!bill.removed}">
                                    ...
                                    <a href="/housing/tenant/payBill/${bill.id}">
                    ...
                    <td>
                        <a href="/housing/exportBill/${bill.id}">
