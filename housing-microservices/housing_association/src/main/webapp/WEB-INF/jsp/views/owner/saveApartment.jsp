...
<div class="jumbotron">
    <div class="custom-container-big">
        ...
        <form:form action="/housing/owner/saveApartment" method="post" modelAttribute="apartment">
            <form:hidden path="id"/>
            ...
            <%--Buttons--%>
            <div class="Row">
                <div class="Column"><a href="/housing/owner/saveBuilding/${apartment.building.id}"><input type="button"
