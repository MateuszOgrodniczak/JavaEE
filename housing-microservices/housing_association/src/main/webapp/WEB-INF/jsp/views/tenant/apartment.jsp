...
<div class="jumbotron">
    <div class="custom-container-big">
        ...
        <%--Buttons--%>
        <div class="Row">
            <div class="Column"><a href="/housing/tenant"><input type="button" class="btn btn-danger" style="width:115%"
                                                         value='<spring:message code="label.cancel"/>'></a></div>
            <div class="Column"><a href="/housing/tenant/leaveApartment/${apartment.id}"><input type="button"
        ...
        <%@include file="tenantConsumptions.jsp" %>
            <form action="/housing/tenant/getConsumptions/${apartment.id}" method="get">
