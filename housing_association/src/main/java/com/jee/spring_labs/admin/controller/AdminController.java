...
public class AdminController {
    ...
    public ModelAndView getAdminPage(@ModelAttribute("removeSuccess") String removeSuccess,
                                     @ModelAttribute("removeError") String removeError) {
    ...
    @GetMapping("/requests")
    public ModelAndView getRequests(@RequestParam(name = "subject", required = false) String subject, @RequestParam(name = "suffix", required = false) String suffix,
                                    @RequestParam(name = "removed", required = false) Boolean removed) {
        ModelAndView mv = redirectToRestController("requests", suffix, subject);
        if (mv == null) {
            subject = (subject == null) ? "" : subject;
            removed = (removed == null) ? false : removed;
            mv = new ModelAndView("redirect:/userRequests/admin/requests?subject=" + subject + "&removed=" + removed);
        }
        return mv;
    }
