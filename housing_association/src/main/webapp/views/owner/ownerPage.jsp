...
<div class="jumbotron">
    <div class="custom-container-big">
        ...
        <div id="buildings">
            ...
            <form action="/owner/buildings" method="get">
        ...
        <div id="bills">
            ...
            <form action="/owner/bills" method="get">
                <div class="Row">
                    <div class="Column"><input type="submit" class="btn btn-info"
                                               value='<spring:message code="label.search"/>'/>
                    </div>
        ...
        <div id="consumptions">
            ...
            <form action="/owner/consumptions" method="get">
                <div class="Row">
                    <div class="Column">
        ...
        <form action="/userRequests/owner/requests" method="get">
                <span class="custom-input">
                    <input type="text" name="subject" class="form-control-inline"
            ...
            <div class="Row">
                ...
                <div class="Column">
                    <a href="/userRequests/owner/saveRequest" class="btn btn-success" style="width: 115%">
