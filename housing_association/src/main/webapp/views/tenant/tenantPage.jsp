...
<div class="jumbotron">
    <div class="custom-container-big">
        ...
        <form action="/tenant/apartments" method="get">
            <div class="Row">
        ...
        <form action="/tenant/bills" method="get">
            <div class="Row">
                <div class="Column" style="padding-top: 0px"><input type="submit" class="btn btn-info"
                                           value='<spring:message code="label.search"/>'/>
                </div>
        ...
        <form action="/userRequests/tenant/requests" method="get">
            ...
            <div class="Row">
                ...
                <div class="Column">
                    <a href="/userRequests/tenant/saveRequest" class="btn btn-success" style="width: 115%">
