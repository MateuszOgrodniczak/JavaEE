...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="/home"><spring:message code="label.home"/></a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
        <ul class="navbar-nav mr-auto">
            <sec:authorize access="isAuthenticated()">
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="/${authorityLowerCase}"><spring:message
        ...
        <sec:authorize access="isAnonymous()">
            <a class="navbar-brand" href="/home/login"><spring:message code="label.login"/></a>
            <a class="navbar-brand" href="/home/register"><spring:message code="label.register"/></a>
        </sec:authorize>
        <sec:authorize access="isAuthenticated()">
            <sec:authentication var="username" property="principal.username"/>
            <a class="navbar-brand" href="/home/account/${username}">${username}</a>
            <a class="navbar-brand" href="/home/logout"><spring:message code="label.logout"/></a>
        </sec:authorize>
    </div>
</nav>