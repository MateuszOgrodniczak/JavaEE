...
<div class="jumbotron">
    <div class="custom-container-big">
        ...
        <div class="Row">
            <div class="Column"><a href="/exportToPdf/${bill.id}"><input type="button" class="btn btn-success" style="width:115%"
        ...
        <%--Buttons--%>
        <div class="Row">
            <div class="Column"><a href="/${userType}"><input type="button" class="btn btn-danger" style="width:115%"
