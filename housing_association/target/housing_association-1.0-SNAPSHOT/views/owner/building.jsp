...
<div class="jumbotron">
    <div class="custom-container-big">
        ...
        <form:form action="/owner/saveBuilding" method="post" modelAttribute="building">
            <form:hidden path="id"/>
            ...
            <%--Buttons--%>
            <div class="Row">
                <div class="Column"><a href="/owner"><input type="button" class="btn btn-danger" style="width:115%"
            ...
            <c:when test="${building.apartments != null && not empty building.apartments}">
                <table class="table table-hover">
                    ...
                    <c:forEach var="apartment" items="${building.apartments}">
                        ...
                        <td>
                            <a href="/owner/saveApartment/${building.id}/${apartment.id}">
                        ...
                        <c:if test="${apartment.removed == false}">
                                <a href="/owner/removeApartment/${apartment.id}">
        ...
        <div class="Row">
            <div class="Column">
                <a href="/owner/saveApartment/${building.id}" class="btn btn-success" style="width: 115%">+
